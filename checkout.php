...
<section class="py-5">
    <div class="container">
        <div class="card rounded-0">
            ...
            <h3 class="text-center"><b>Thủ tục thanh toán</b></h3>
            ...
            <form action="" id="place_order">
                ...
                <div class="row row-col-1 justify-content-center">
                    ...
                    <label for="" class="control-label">Kiểu đơn hàng</label>
                    </div>
                    <div class="form-group d-flex pl-2">
                        <div class="custom-control custom-radio">
                          ...
                          <label for="customRadio4" class="custom-control-label">Giao hàng</label>
                        </div>
                        <div class="custom-control custom-radio ml-3">
                          ...
                          <label for="customRadio5" class="custom-control-label">Thanh toán tại quầy( Tự đến lấy hàng )</label>
                        </div>
                      </div>
