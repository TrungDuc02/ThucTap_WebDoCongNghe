    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Xóa hết</button>
            </div>
        </div>
        ...
        <div class="d-flex w-100 justify-content-end">
            <a href="./?p=checkout" class="btn btn-sm btn-flat btn-dark">Thủ tục thanh toán</a>
        </div>
    </div>
</section>
<script>
    ...
    $(function(){
        ...
        $('#empty_cart').click(function(){
            // empty_cart()
            _conf("Bạn có chắc chắn để trống danh sách giỏ hàng của bạn?",'empty_cart',[])
        })
        $('.rem_item').click(function(){
            _conf("Bạn có chắc chắn xóa mặt hàng trong danh sách giỏ hàng không?",'rem_item',[$(this).attr('data-id')])
        })
    })
</script>