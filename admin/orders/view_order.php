    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <p>Kiểu đơn hàng: <?php echo $order_type == 1 ? '<span class="badge badge-light text-dark">Giao hàng</span>' : '<span class="badge badge-light text-dark">Thanh toán tại quầy( Tự đến lấy hàng )</span>' ?></p>
            </div>
            <div class="col-6 row row-cols-2">
            <div class="col-3" style="display: inline; white-space: nowrap;">Tình trạng đơn hàng:   </div>
                <div class="col-9">
                <?php 
                    switch($status){
                        case '0':
                            echo '<span class="badge badge-light text-dark">Chưa giải quyết</span>';
	                    break;
                        case '1':
