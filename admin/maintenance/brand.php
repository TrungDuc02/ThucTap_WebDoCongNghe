...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có chắc chắn xóa Thương hiệu này vĩnh viễn không?","delete_brand",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Thêm thương hiệu mới","maintenance/manage_brand.php")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Cập nhật chi tiết thương hiệu","maintenance/manage_brand.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
