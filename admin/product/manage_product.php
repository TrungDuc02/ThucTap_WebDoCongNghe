...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="category_id" class="control-label">Loại danh mục</label>
            ...
            <div class="form-group">
                ...
                <option value="" selected="" disabled="">Chọn danh mục đầu tiên</option>
                <?php
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=product">Hủy bỏ</a>
	</div>
</div>
<script>
